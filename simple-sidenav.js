// Update hidden field with navigation links values
    ...
    //		jQuery('input[id^="simple_sidenav_add_page_"]').click(function() {
		...
		jQuery(document).ready(function(){
			jQuery('body').on('click', 'input[id^="simple_sidenav_add_custom_"]', function(){
				var id = jQuery(this).attr("id");
				sn_add_custom(id);
			});
			
			jQuery('body').on('click', 'input[id^="simple_sidenav_add_child_custom_"]', function(){
				var id = jQuery(this).attr("id");
				sn_add_child_custom(id);
			});
			
			jQuery('body').on('click', 'input[id^="simple_sidenav_add_page_"]', function(){
				var id = jQuery(this).attr("id");
				sn_add_page(id);
			});
					
			jQuery('body').on('click', 'input[id^="simple_sidenav_add_child_page_"]', function(){
				var id = jQuery(this).attr("id");
				sn_add_child_page(id);
			});

			jQuery('body').on('click', 'input[id^="simple_sidenav_move_up_"]', function(){
				var id = jQuery(this).attr("id");
				sn_move_up(id);
			});			

			jQuery('body').on('click', 'input[id^="simple_sidenav_move_down_"]', function(){
				var id = jQuery(this).attr("id");
				sn_move_down(id);
			});	

			jQuery('body').on('click', 'input[id^="simple_sidenav_remove_"]', function(){
				var id = jQuery(this).attr("id");
				sn_remove(id);
			});	
			
			
			jQuery('body').on('click', 'a[id^="simple_sidenav_delete_all_"]', function(){
				var id = jQuery(this).attr("id");
				sn_delete_all(id);
			});	
		
			
			jQuery('body').on('click', 'select[id^="simple_sidenav_navlinks_"]', function(){
				var id = jQuery(this).attr("id");
				sn_hint(id);
			}).change();	
